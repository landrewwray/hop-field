...
def distortionList(theCoords,theBonds,bondNumArray,fixPosSet=set(),distortDist=0.01,distortAxis=[]):
    newCoordsList = [distort_molecule(theCoords,theBonds,i,bondNumArray[np.arange(len(bondNumArray))!=i],distortDist=0.01,distortAxis=[]) for i in bondNumArray]
